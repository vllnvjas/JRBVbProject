...
<div class="card border-0">
    <div class="card-body p-4 p-md-5">
        ...
        <div id="adminEditStudentForm" data-js-form data-action="{{ route('admin.students.update', $student->id) }}" data-reload-on-success="false" data-success-message="Student updated successfully.">
            @csrf
            @method('PUT')
