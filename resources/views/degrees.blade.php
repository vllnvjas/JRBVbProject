    ...
    <div class="col-lg-4">
        <div class="card border-0">
            <div class="card-body">
                ...
                @endif
                <div data-js-form data-action="{{ route('degrees.store') }}">
                    @csrf
                    <div class="mb-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('degrees.edit', $degree->id) }}" class="btn btn-warning btn-sm px-3">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <div class="d-inline-block ms-1" data-js-form data-action="{{ route('degrees.destroy', $degree->id) }}">
                                        @csrf
                                        @method('DELETE')
